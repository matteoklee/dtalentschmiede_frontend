...
export function getHardSkillIcon(skillName) {
    switch (skillName) {
        case 'DEVOPS': return IconServer;
        case 'PROGRAMMING': return IconCode;
        case 'DATABASE_MANAGEMENT': return IconDatabase;
        case 'SECURITY': return IconSecurity;
        case 'AGILE': return IconAgil;
        case 'DOCUMENTATION': return IconFile;
        case 'VERSION_CONTROL': return IconGit;
        case 'TESTING': return IconTesting;
        case 'SOFTWARE_ARCHITECTURE': return IconArchitecture;
        default: return IconOther;
    }
}
...
export function getSoftSkillIcon(skillName) {
    switch (skillName) {
        case 'REQUIREMENTS_ENGINEERING': return IconClipboard;
        case 'PROJECT_MANAGEMENT': return IconList;
        case 'CLIENT_INTERACTION': return IconHandshake;
        case 'PROBLEM_SOLVING': return IconLightbulb;
        case 'TEAMWORK': return IconUsers;
        case 'TIME_MANAGEMENT': return IconClock;
        default: return IconOther;
    }
}
