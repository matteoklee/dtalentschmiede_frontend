          ...
          <div class="group border rounded-xl hover:shadow-xl duration-300 transition-all lg:my-6 my-4 lg:mx-0 mx-4 lg:py-6 py-4 px-8">
            <div class="flex lg:flex-row flex-col lg:items-center items-start justify-between space-y-2">
              ...
              <div class="flex flex-col justify-center text-left">
                <p class="text-gray-800 text-lg font-medium group-hover:font-bold group-hover:text-primary-600">Marktpreise 2024</p>
              ...
              <div class="flex flex-row justify-center items-center">
                <p class="bg-gray-300 text-white text-xs uppercase py-2 px-4 rounded-lg mr-2">Vue</p>
                <p class="bg-gray-300 text-white text-xs uppercase py-2 px-4 rounded-lg mr-2">React</p>
                <p class="bg-gray-300 text-white text-xs uppercase py-2 px-4 rounded-lg">Spring Boot</p>
              </div>
              <div class="flex flex-col justify-center text-left">
              ...
              <div>
                <button
                    type="button"
                    @click="clear"
                    class="bg-primary-600 shadow-md shadow-primary-600/50 px-6 py-3 rounded-lg text-white hover:bg-primary-700 transition"
                >Ansehen</button>
              </div>
            </div>
          </div>
