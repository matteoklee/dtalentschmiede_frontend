<template>
  ...
  <button data-modal-target="select-modal" data-modal-toggle="select-modal"
          class="bg-red-700 shadow-md px-6 py-3 rounded-lg hover:bg-red-800 text-white lg:mr-4" type="button">
    Erstellen
  </button>

  <!-- Main modal -->
  <div id="select-modal" tabindex="-1" aria-hidden="true" class="hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-screen-md max-h-full">
      ...
      <div class="relative bg-white rounded-lg shadow">
        ...
        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
          ...
          <button type="button" class="text-gray-400 bg-transparent hover:text-gray-900 rounded-lg text-sm h-8 w-8 ms-auto inline-flex justify-center items-center" data-modal-toggle="select-modal">
        ...
        <div class="p-4 md:p-5">
          ...
          <ul class="lg:space-x-4 lg:space-y-0 space-x-0 space-y-4 mb-6 flex lg:flex-row flex-col justify-center lg:items-center">
            <li class="">
              <input type="radio" id="job-1" name="job" value="job-1" class="hidden peer" required />
              <label for="job-1" class="aspect-square h-48 inline-flex items-center justify-between w-full p-5 text-gray-900 bg-white border border-dashed border-2 border-gray-200 rounded-lg cursor-pointer peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-900 hover:bg-gray-100">
                <div class="block">
